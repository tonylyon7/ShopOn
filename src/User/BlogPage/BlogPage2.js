...
const BlogPage2 = () => {
  return (
    <div className='mt-5'>
      ...
      <p className='mt-2 text-start blog-para'>One of the most important aspects of vacation has always been choosing accommodations. Finding somewhere relaxing and clean with modern furniture <br className='none'/> and close to amenities can sometimes make or break a vacation .Choosing a hotel has always been at the top of a priority list when it came to vacation...</p>
