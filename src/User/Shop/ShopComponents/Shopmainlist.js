                ...
                <div className='col-9 pb-3'>
                    <div className='d-flex justify-content-between malsmnav2'>
                        <div className='d-flex' style={{width: "30%"}}>
                            ...
                            <div className='d-flex justify-content-between malsmnav22' style={{width: "65%"}}>
                    ...
                    <div className='container-fluid'>
                        <div className='row'>
                            ...
                            <div className='col-9 pt-5'>
                                <p className='text-muted malwrop m-0'>Bucklo Wrop Wooden Table</p>
                                <p className='text-dark maldoll m-0'>$45.98</p>
                                <div className='m-0'>
                                    <input type="color" className='malsmcoloo' style={{width: "22px", height: "20px"}} value="#828282"/>
                                    <input type="color" className='malsmcoloo' style={{width: "22px", height: "20px"}} value="#BDBDBD"/>
                                    <input type="color" className='malsmcoloo' style={{width: "22px", height: "20px"}} value="#0F2C72"/>
                                    <input type="color" className='malsmcoloo' style={{width: "22px", height: "20px"}} value="#EB5757"/>
                                    <input type="color" className='malsmcoloo' style={{width: "22px", height: "20px"}} value="#F2994A"/>
                                </div>
                                <p className='malsmlsed'>Sed vulputate elit vitae magna lacinia, vel bibendum neque faucibus. Aliquam sed volutpat turpis, phasellus nisl arcu,..</p>
                            </div>
                        </div>
                        <div className='row'>
                            <div className='col-3'>
